...
window.addEventListener("touchstart",   function(event){controller.handleGesture.call(controller,event);});
    window.addEventListener("touchmove",   function(event){controller.handleGesture.call(controller,event);});
    window.addEventListener("touchend",   function(event){controller.handleGesture.call(controller,event);});
